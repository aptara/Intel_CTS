namespace IntelGameAPI.DataAccess
{
    ...
    ///		as we will be using TransactionScope for transaction propagation across
    ///		various methods/layers.
    ///	3.	It encapsulate DAAB database object creation - although, DAAB provides 
    ...
    ///		elements.
    ///	4.	Some additional tweaking can be done here such as setting up the
    ///		command time-out.
    ...
    public static class DbHelper
    {
        ...
        private static Database GetDatabase()
        {
            ...
            const string Key = "IntelGame_database";
